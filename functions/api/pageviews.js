export async function onRequest(context) {
  ...
  try {
    ...
    // 2. Fetch pageviews from Umami Cloud using share headers
    const res = await fetch(
      `https://cloud.umami.is/analytics/us/api/websites/${websiteId}/pageviews?startAt=${startAt}&endAt=${endAt}&unit=${unit}&timezone=Asia/Shanghai`,
      {
        headers: {
