...
本教程以 **Clash Verge Rev** 为例，手把手教您完成从下载安装到成功科学上网的全过程。Clash Verge Rev 是目前 PC 端最推荐的代理客户端，界面清晰、内置 TUN 模式、支持规则分流。要配置本软件，你需要先从 [2026年稳定便宜好用机场推荐列表](./README.md) 或专为学生准备的 [学生党高性价比便宜机场精选](./cheap-airport.md) 中获取节点订阅地址。
