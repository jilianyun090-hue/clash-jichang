        ...
        "/streaming/": [
            {
                text: "流媒体指南",
                children: [
                    { text: "流媒体注册与使用汇总指南", link: "" },
                    { text: "海外接码平台实测与教程", link: "sms-guide" },
                    { text: "Netflix 4K 极速观看指南", link: "netflix-guide" },
                    { text: "Disney+ 订阅与观看指南", link: "disney-guide" },
                    { text: "Spotify Premium 拼车指南", link: "spotify-guide" },
                    { text: "YouTube Premium 订阅攻略", link: "youtube-guide" },
                    { text: "HBO Max/Go 合租观看指南", link: "hbo-max-guide" },
                    { text: "Hulu 与 HBO 美区解锁指南", link: "hulu-hbo-guide" },
                ],
            },
        ],
        "/account/": [
        ...
        "/airport/": [
            {
                text: "推荐与测评指南",
                children: [
                    { text: "最新翻墙机场推荐与评测指南", link: "" },
                    { text: "常用稳定机场推荐排行榜", link: "best-airport-2026" },
                    { text: "学生党便宜性价比机场推荐", link: "cheap-airport" },
                    { text: "选购必看：机场避坑指南", link: "choose-guide" },
                    { text: "IEPL/IPLC/BGP 专线对比", link: "iepl-iplc" },
                ],
            },
            {
                text: "客户端下载与配置",
        ...
        "/ai/": [
            {
                text: "AI 工具实战",
                children: [
                    { text: "AI 专用机场解锁推荐", link: "" },
                    { text: "ChatGPT 深度使用教程", link: "chatgpt" },
                    { text: "Claude 3.5 注册与使用", link: "claude-guide" },
                    { text: "Google Gemini 直连使用", link: "gemini" },
                    { text: "Grok 4 使用与国内访问", link: "grok-guide" },
                    { text: "Midjourney 绘画全解析", link: "midjourney-guide" },
                    { text: "Cursor AI 编程编辑器教程", link: "cursor-guide" },
                    { text: "OpenClaw 聚合配置教程", link: "openclaw-guide" },
                ],
            },
        ],
        "/proxy/": [
